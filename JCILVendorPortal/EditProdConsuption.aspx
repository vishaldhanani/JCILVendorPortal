<%@ Page Language="C#" MasterPageFile="~/VMaster.Master" AutoEventWireup="true" CodeBehind="EditProdConsuption.aspx.cs" Inherits="JCILVendorPortal.EditProdConsuption" %>
                            ...
                            <div class="widget-content">
                                    ...
                                    <div>
                                        <div class="widget-header">
                                           ...
                                           <h3> Posted Entry No: <asp:Label ID="lblProductionOrderNo" runat="server" Text="" ForeColor="Blue"></asp:Label> 
                                        </div>
