<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="JCILVendorPortal.Account.Manage" %>
            ...
            <fieldset>
                ...
                <ol>
                    <li>
                        ...
                        <asp:TextBox  Enabled ="false" runat="server" ID="password" TextMode="Password" />
                    ...
                    <li>
                        ...
                        <asp:TextBox  Enabled ="false" runat="server" ID="confirmPassword" TextMode="Password" />
                    ...
                    <fieldset class="changePassword">
                        ...
                        <ol>
                            <li>
                                ...
                                <asp:TextBox  Enabled ="false" runat="server" ID="CurrentPassword" CssClass="passwordEntry" TextMode="Password" />
                            ...
                            <li>
                                ...
                                <asp:TextBox  Enabled ="false" runat="server" ID="NewPassword" CssClass="passwordEntry" TextMode="Password" />
                            ...
                            <li>
                                ...
                                <asp:TextBox  Enabled ="false" runat="server" ID="ConfirmNewPassword" CssClass="passwordEntry" TextMode="Password" />
