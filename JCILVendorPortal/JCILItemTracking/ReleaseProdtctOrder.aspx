<%@ Page Language="C#" MasterPageFile="~/VMaster.Master" AutoEventWireup="true" CodeBehind="ReleaseProdtctOrder.aspx.cs" Inherits="JCILVendorPortal.ReleaseProdtctOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="span12">
                        <div class="widget ">
                            ...
                            <div class="widget-content">
                                <asp:Panel ID="pnlHide" runat="server" Style="text-align: left;">
                                    <div class="dvPanel">
                                        <div class="dvPanelInside">
                                            <span style="font-weight: 700;">Item: </span>
                                            <asp:DropDownList ID="drpItem" runat="server" TabIndex="1" CssClass="span3"></asp:DropDownList>
                                        </div>
                                        <%--<div class="dvPanelInside">
                                            <span style="font-weight: 700;">Creation Date: </span>
                                            <asp:TextBox ID="txtDate" runat="server" class="span2" MaxLength="15" TabIndex="2" autocomplete="off" onkeypress="return validateQty(event);" onkeydown="return validateQty1(event);"></asp:TextBox>
                                            
                                            <ajax:CalendarExtender ID="CalendarExtender2" TargetControlID="txtDate" Format="dd/MM/yyyy" runat="server"></ajax:CalendarExtender>
                                        </div>--%>
                                        <div class="dvButton">
                                            <asp:Button ID="btnCreate" runat="server" Text="Create" CssClass="btn btn-primary header-btn" TabIndex="3" OnClientClick="return validate();" OnClick="btnCreate_Click" />
                                        </div>
                                    </div>
                                </asp:Panel>
                                <table runat="server" id="tblID" visible="false"  class="table table-bordered" style="margin-bottom: 8px;">
                                    <tr>

                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblNmbr" class="control-label  boldfontLeft " runat="server" Text="No." Style="color:green;"></asp:Label>
                                        </td>

                                        <td>
                                            <asp:Label ID="lblNo" runat="server" Style="color:blue;"></asp:Label>
                                        </td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblItemNo" runat="server" Style="color:blue;"></asp:Label>
                                            <asp:Label ID="lblItemDescription" runat="server" Style="color:blue;" Width="220px" ></asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtPostingDate" ForeColor="Red" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$"
    ErrorMessage="*" ValidationGroup="Group1" />
                                        ...
                                        <td>
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtDocumentDate" ForeColor="Red" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$"
    ErrorMessage="*" ValidationGroup="Group1" />
            ...
            <asp:Label ID="lblnameForSum" runat="server" Text="Total Output" Visible="false" />
                                                ...
                                                <asp:TemplateField HeaderText="Qty in (Tons)">
                                                    <ItemTemplate>
