<%@ Page  Language="C#" MasterPageFile="~/VMaster.Master" AutoEventWireup="true" CodeBehind="ReRegistrationVendor.aspx.cs" Inherits="JCILVendorPortal.ReRegistrationVendor" %>
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div style="float: left; margin-right: 22px; margin-left: 7px;">
                                                    ...
                                                    <td>Country</td>
                                                            ...
                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td>Phone No. </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtLine3Office" runat="server" onkeypress="return validateQty2(event);" class="span3" MaxLength="12"></asp:TextBox>
                                                                </td>
                                                                                                                                <td>FAX No. </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtMobileNoOffice" runat="server" onkeypress="return validateQty2(event);" class="span3" MaxLength="10"></asp:TextBox>
                                                                                                                                 ...
                                                                                                                                 <td>Email Id </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtEmailIDOffice" runat="server" class="span5" MaxLength="200"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="tab-pane" id="ContactDetails">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <asp:TextBox ID="txtURL" runat="server" class="span3" MaxLength="60"></asp:TextBox>
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>PAN No.</td>
                                                                <td>
                                                                    <asp:TextBox ID="txtPAN" runat="server" class="span2" MaxLength="10"></asp:TextBox>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Bank A/c No</td>
                                                        <td>
                                                            <asp:TextBox ID="txtAcntNo" runat="server" class="span4" MaxLength="20" onkeypress="return validateQty2(event);"></asp:TextBox>
                                        ...
                                        <div class="tab-pane" id="NavSetupFields">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <asp:Button ID="Button11" runat="server" class="btn header-btn" Text="Cancel"></asp:Button>
                                                <asp:Button ID="Button12" Text="Save" CssClass="btn btn-primary header-btn" OnClientClick="return validate();" runat="server" CausesValidation="false" OnClick="btnSave_Click" />
...
<%--    <script src="js/jquery-1.7.2.min.js"></script>
    ...
    <script type="text/javascript">
        function validate() {
            ...
            var DirectName = document.getElementById('<%=txtDirectName.ClientID %>').value;
            var DirectPhone = document.getElementById('<%=txtDirectPhone.ClientID %>').value;
            var DirectMobile = document.getElementById('<%=txtDirectMobile.ClientID %>').value;
            var DirectEmail = document.getElementById('<%=txtDirectEmail.ClientID %>').value;
            var SaleName = document.getElementById('<%=txtSaleName.ClientID %>').value;
            var SalePhone = document.getElementById('<%=txtSalePhone.ClientID %>').value;
            var SaleMobile = document.getElementById('<%=txtSaleMobile.ClientID %>').value;
            var SaleEmail = document.getElementById('<%=txtSaleEmail.ClientID %>').value;
            var AccountName = document.getElementById('<%=txtAccountName.ClientID %>').value;
            var AccountPhone = document.getElementById('<%=txtAccountPhone.ClientID %>').value;
            var AccountMobile = document.getElementById('<%=txtAccountMobile.ClientID %>').value;
            var AccountEmail = document.getElementById('<%=txtAccountEmail.ClientID %>').value;
            ...
            if (PremiseOffice == "") {
                alert("Please enter Premise(H.O.) information.");
                return false;
            }
            if (PremiseWorkshop == "") {
            ...
            if (DirectPhone == "") {
                alert("Please enter Director Phone number.");
                return false;
            }
            if (DirectMobile == "") {
                alert("Please enter Director Mobile number.");
                return false;
            }
            if (DirectEmail == "") {
                alert("Please enter Director Email ID.");
                return false;
            }
            if (SaleName == "") {
            ...
            if (SalePhone == "") {
                alert("Please enter Sales Person phone number.");
                return false;
            }
            if (SaleMobile == "") {
                alert("Please enter Sales Person mobile number.");
                return false;
            }
            if (SaleEmail == "") {
                alert("Please enter Sales Person Email Id.");
                return false;
            }
            if (AccountName == "") {
                alert("Please enter Account Person name.");
                return false;
            }
            if (AccountPhone == "") {
            ...
            if (AccountMobile == "") {
                alert("Please enter Account Person mobile number.");
                return false;
            }
            if (AccountEmail == "") {
                alert("Please enter Account Person Email Id.");
                return false;
            }
            if (CST == "") {
